<?php
/**
 * Plugin Name: SEO Ops Connector
 * Description: Connects a WordPress site to SEO Ops for posts, pages, Site Kit status, and analytics report proxying.
 * Version: 1.0.0
 * Author: SEO Ops
...
final class SEO_Ops_Connector
{
    ...
    private static function cors(): void
    {
        ...
        header('Access-Control-Allow-Headers: X-SEO-OPS-KEY, Content-Type, Authorization');
        header('Access-Control-Allow-Methods: GET, POST, OPTIONS');
    }
}

SEO_Ops_Connector::boot();
register_activation_hook(__FILE__, ['SEO_Ops_Connector', 'activate']);
